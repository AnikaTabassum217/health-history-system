...
public class DoctorPrescriptionFrame extends JFrame implements ActionListener {
    ...
    public DoctorPrescriptionFrame(Users user) {
        super("Doctor Prscription Frame");
        this.user = user;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (command.equals(getAllBtn.getText())) {
            ...
            ArrayList<Prescription> prescriptionData = prescriptionRepo.getPrescription(this.getPatientId());
            ...
            DoctorSelectPatientFrame spf = new DoctorSelectPatientFrame(this.user);
            spf.setVisible(true);
